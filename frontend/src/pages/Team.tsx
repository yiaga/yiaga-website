...
import segunImg from "@/assets/team/Segun.jpeg";
import solomonImg from "@/assets/team/Solomon.jpeg";
import stephenImg from "@/assets/team/Stephen.jpg";
import toluImg from "@/assets/team/Tolu.jpg";
import toniaImg from "@/assets/team/Tonia.jpeg";
...
import emmanuelImg from "@/assets/team/Emmanuel.jpg";
...
const teamList = [
  { name: "Olusegun Ogundare", role: "Research (Africa Division)", image: segunImg },
  ...
  { name: "Emmanuel Chukwuebuka Opara", role: "Digital Design Officer", image: emmanuelImg },
  { name: "Elizabeth Lawani", role: "Videographer", image: elizabethImg },
  { name: "Bharat Belamo", role: "Videographer", image: bharatImg },
  ...
  { name: "Solomon Yakubu", role: "Program Assistant, Media & Communication", image: solomonImg },
  ...
  { name: "Stefan Chega Sande", role: "IT Assistant", image: stefanImg },
  { name: "Ibrahim Seray Jah", role: "Intern, KML", image: null },
  { name: "Victor Itopa John", role: "Intern, Finance", image: null },
  { name: "Irene Osabuiohien", role: "Intern (NYSC)", image: ireneImg },
